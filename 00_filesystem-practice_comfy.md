...
```r
#first create as project usethis::create_project("~/i_exist")
usethis::create_project("~/Documents/Rcode/rstudio_forgot")
```

```
## Changing active project to rstudio_forgot
## Overwrite pre-existing file 'rstudio_forgot.Rproj'?
## 1: No
## 2: Negative
## 3: Yes
```
...
```
## Error: 'rstudio_forgot.Rproj' already exists.
```
...
```
## Error in file.copy(from_files, to_files): object 'from_files' not found
```
...
```
## Error in which(is.na(x)): object 'from_files' not found
```
